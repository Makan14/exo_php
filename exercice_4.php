...
<body>
	<div class="container">
		<div class="row alert bg-danger mt-4 mb-4">
		...
		<div class="row mt-5">
			...
			<?php } ?>
				...
				<div class="card mt-8">
					<h5 class="card-header bg-danger text-center">Répertoire des contacts</h5><!-- /.card-header alert-danger -->
					...
					while ($ligne = $table_contacts->fetch(PDO::FETCH_ASSOC)) { // $ligne => 1 ligne de la table de la BDD
						echo '<tr>';
							...
							echo '<td><a href="?id_contact='. $ligne['id_contact'] .'" class="btn btn-danger">Détails</a></td>';
						echo '</tr>';
					}
					?>
					</table>
			...
			<div class="col-6 pr-0">
				<div class="card mt-8">
					<h5 class="card-header bg-danger text-center"><?php echo $prenom  . ' ' . $nom ?></h5><!-- /.card-header alert-danger --> 
					<table class="table table-striped table-hover table-dark mb-0">
						<tr>
							<th class="col-3">#</th>
					...
					<a href="?" class="btn btn-block btn-danger text-center">Fermer la fiche contact</a>
				</div><!-- /. card mt-8 -->
